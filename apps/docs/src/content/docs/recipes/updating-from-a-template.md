...
- **Afterwards**, run your package manager's install if dependencies changed, then `typecheck` and a visual pass — a template update is a code change like any other.
